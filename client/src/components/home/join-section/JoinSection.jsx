        ...
        <div className="relative bg-gradient-radial  w-full 2xl:max-w-[1280px] h-[484px]  pt-[80px]">
          <div className="pr-[100px] flex flex-col  items-end ">
            <div className="space-y-[52px]">
              ...
              <a href="https://wa.me/6285236455624" target="_blank" rel="noreferrer">
                ...
                <a href="https://wa.me/6285236455624" target="_blank" rel="noreferrer" className="px-[64px] py-[16px] w-[232px] flex justify-center items-center rounded-[10px] bg-whiteSmoke500 border-[1px] ">
