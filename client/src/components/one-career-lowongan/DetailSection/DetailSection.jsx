...
function DetailSection(props) {
  const formLink = props.lowongan.link_form_pendaftaran;
  ...
  return (
    <div className="xl:m-20 p-10 grid grid-cols-3 xl:gap-20 lg:gap-10 gap-5 font-heebo text-[#3F4041]">
      ...
      <div className="col-span-1 xl:ml-[10px] md:flex hidden ">
        ...
        >
            <button className="py-3 px-5 rounded-md bg-black text-white w-full" onClick={redirectToForm}>
              Lamar sekarang
            </button>
            ...
            <div className="flex justify-between items-center pt-2 gap-2">
                <button className="rounded-md flex items-center justify-center w-full" onClick={copyToClipboard}>
                    <img
                ...
                <button className="rounded-md flex items-center justify-center w-full" onClick={shareToLinkedin}>
                    <img
                    src={images.Linkedin}
                    alt="Career Momen 2"
                    className="xl:w-[55px] xl:h-[55px] lg:w-[50px] w-[40px]"
                ...
                <button className="rounded-md flex items-center justify-center w-full" onClick={shareToWhatsApp}>
                    <img
                    src={images.Whatsapp}
                    alt="Career Momen 2"
                    className="xl:w-[55px] xl:h-[55px] lg:w-[50px] w-[40px]"
                ...
                <button className="rounded-md flex items-center justify-center w-full" onClick={shareToTelegram}>
                    <img
                    src={images.Telegram}
                    alt="Career Momen 2"
                    className="xl:w-[55px] xl:h-[55px] lg:w-[50px] w-[40px]"
