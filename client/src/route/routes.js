...
import AdminKarirPelamar from "../pages/admin-karir/AdminKarirPelamar";
import AdminKarirPelamarForm from "../pages/admin-karir/AdminKarirPelamarForm";
...
import AddAdmin from "../pages/admin-list-admin/AddAdmin";
...
const routes = [
  ...
  <Route key="admin" path="/admin">
    ...
    />
    <Route
      key="admin-karir-pelamar-form"
      path="karir/pelamar-form"
      element={
        <Protect>
          <AdminKarirPelamarForm />
        </Protect>
      }
    />
    <Route
